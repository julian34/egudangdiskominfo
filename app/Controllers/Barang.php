...
class Barang extends BaseController
{
    ...
    public function listtabeldata(){
        ...
        'rules' => 'uploaded[brggambar]|mime_in[brggambar,image/jpg,image/jpeg,image/gif,image/png]|max_size[brggambar,1096]'
        ],
        ];
        ...
        if($pathGambarLama != 'default-150x150.png'){
            unlink(ROOTPATH .'public/upload/'.$pathGambarLama);
        }
        $namaFileGambar = $data['brgkode'];
        $fileGambar = $this->request->getFile('brggambar');
